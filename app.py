...
CLUSTER_NAMES_AND_PARTICIPATIONS = "welcome_survey_cluster_names_and_descriptions_v2.json"
...
def get_cluster_names_and_descriptions():
    with open(CLUSTER_NAMES_AND_PARTICIPATIONS, "r", encoding='utf-8') as f:
...
with st.sidebar:
    ...
    st.markdown("Pomożemi Ci anelźć osoby które mają podobne zainteresowania")
...
with c1:
    ...
    st.image(f'{predicted_cluster_id}.png')
...
fig.update_layout(
    ...
    xaxis_title="Ulubione_zwierzęta",
    yaxis_title="Liczba osób",
)
st.plotly_chart(fig)
